    ...
    def _init_yolo(self):
        ...
        try:
            ...
            if model_path is None:
                linemod_yolo_path = CURRENT_DIR.parent.parent / "yolo_linemod_training" / "linemod_yolo3" / "weights" / "best.pt"
                if linemod_yolo_path.exists():
                    model_path = str(linemod_yolo_path)
                    logger.info(f"   ✓ 使用LineMOD训练的YOLO模型")
                    self.yolo_model_path = model_path
                else:
                    model_path = "yolov8n.pt"
                    logger.warning(f"   ⚠️ 未找到LineMOD YOLO模型，使用COCO预训练模型")
                    self.yolo_model_path = model_path
...
def main():
    ...
    # 为每个类别选择的测试图片（从测试集中选2-3张）
    test_images_per_class = {
        1: ['0000.png', '0005.png', '0010.png'],   # ape
        2: ['0000.png', '0005.png', '0010.png'],   # benchvise
        4: ['0000.png', '0005.png', '0010.png'],   # cam
        5: ['0000.png', '0005.png', '0010.png'],   # can
        6: ['0000.png', '0005.png', '0010.png'],   # cat
        8: ['0000.png', '0005.png', '0010.png'],   # driller
        9: ['0000.png', '0005.png', '0010.png'],   # duck
        10: ['0000.png', '0005.png', '0010.png'],  # eggbox
        11: ['0000.png', '0005.png', '0010.png'],  # glue
        12: ['0000.png', '0005.png', '0010.png'],  # holepuncher
        13: ['0000.png', '0005.png', '0010.png'],  # iron
        14: ['0000.png', '0005.png', '0010.png'],  # lamp
        15: ['0000.png', '0005.png', '0010.png'],  # phone
    }
    
    # 创建输出目录
    output_dir = CURRENT_DIR / "output_performance"
    ...
    logger.info("\n" + "="*70)
    logger.info("🚀 开始性能测试：从测试集每个类别选择2-3张图片")
    logger.info("="*70)
